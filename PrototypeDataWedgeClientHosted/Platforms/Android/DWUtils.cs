...
namespace PrototypeDataWedgeClientHosted.Platforms.Android.Resources
{
    static class DWUtils
    {
        private const String PROFILE_NAME = "DWPrototypeProfileClientHosted";
